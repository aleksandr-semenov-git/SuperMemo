...
from .views import LessonPage, AddThemePage, ChooseThemePage, AddSectionPage, ChooseSectionPage
...
urlpatterns = [
    ...
    path('learning-page/<int:theme_id>', LessonPage.as_view(), name='lesson_learn'),
